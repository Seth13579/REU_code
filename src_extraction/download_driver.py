...
if __name__ == '__main__':
    if len(sys.argv) != 4:
        print(f'Enter: python {sys.argv[0]} [galaxy name] [radius] [rerun (true or false)]')
        sys.exit()
    ...
    #use t or T in the command line arguments to skip the downloading and reprocessing step
