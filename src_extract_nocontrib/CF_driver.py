...
def process_galaxy(obsids,galaxy,rerun):
    if not rerun:
...
if __name__ == '__main__':
    ...
    rerun = 't' in sys.argv[1] or "T" in sys.argv[1]

    with open('obsid_list.txt', 'r') as file:
        obsids = file.read().splitlines()[1:]

    process_galaxy(obsids,galaxy,rerun)
